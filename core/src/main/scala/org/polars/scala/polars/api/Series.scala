...
object Series {
  ...
  /** Initialize new nested series by name and values of provided type.
    ...
    */
  def ofList(name: String, values: java.lang.Iterable[java.lang.Iterable[?]]): Series =
  ...
  /** Initialize new nested series by name and values of provided type.
    ...
    *   [[java.lang.ArrayIndexOutOfBoundsException]].
    */
  def ofList(name: String, values: Iterable[Iterable[?]]): Series =
    Series.ofList(name, values.map(_.asJava.asInstanceOf[java.lang.Iterable[?]]).asJava)
